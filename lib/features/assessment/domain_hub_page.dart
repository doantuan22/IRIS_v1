        ...
        builder: (context, snapshot) {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Card(
                  color: IrisDomainStyle.softColorOf(widget.linhVuc),
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Icon(
                              IrisDomainStyle.iconOf(widget.linhVuc),
                              size: IrisSizes.iconSmall,
                              color: accent,
                            ),
                ...
                _HubNavigationCard(
                  ...
                  subtitle:
                      'Xem các biểu hiện thường gặp và những điểm cần quan sát thêm ở độ tuổi này.',
    ...
    return Card(
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              IrisIconChip(icon: icon, color: color),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
